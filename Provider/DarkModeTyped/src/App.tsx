import { ComponentPropsWithoutRef, memo, PropsWithChildren, useCallback, useState } from "react";
...
function Button({ children, ...rest }: PropsWithChildren<ComponentPropsWithoutRef<"button">>) {
